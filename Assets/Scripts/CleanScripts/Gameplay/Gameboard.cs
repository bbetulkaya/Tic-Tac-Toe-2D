...
namespace CleanCode
{
    public class Gameboard : MonoBehaviour
    {
        ...
        public bool SaveSelectedGrid(GameObject grid, Character currentPlayer)
        {
            ...
            {
                GameBoard[posCol, posRow] = currentPlayer.characterValue;
                grid.GetComponent<SpriteRenderer>().sprite = currentPlayer.characterSprite;
